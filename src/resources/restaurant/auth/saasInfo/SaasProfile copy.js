                ...
                >
                  <div className="t-pl-15 t-pr-15">
                    <div className="row container d-flex justify-content-center">
                      <div className="col-lg-12 mt-5 col-md-12">
                        <div className="card saas-user-card-full">
                          <div className="row m-l-0 m-r-0">
                            <div className="col-sm-4  user-profile">
                              <div className="card-block text-center text-white saas_history_card">
                                ...
                                <h6 className="text-left margin-bottom-20">
                                  user Information
                                </h6>
                                {saasUserInfo.payment_histories.map(
                                  (item, index) => {
                                    ...
                                    return (
                                      <ul
                                        key={index}
                                        className="text-dark text-left saas_history_list"
                                      >
                                        <li>
                            ...
                            <div className="col-sm-8">
                              <div className="card-block saas_user_info">
                                <h5 className="f-w-600 title">
                                  User Information
                                </h5>
                                <div className="row">
                                  <ul className="saas_user_info_list">
                                    ...
                                    <li>
                                      <strong>rest_name</strong>:{" "}
                                      {saasUserInfo.rest_name}
                                    </li>
                                    <li>
                                      <strong>rest_address</strong>:{" "}
                                      {saasUserInfo.rest_address}
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      ...
                                      {saasUserInfo.total_items}
                                    </li>
                                    <li>
                                      <strong>payment_status</strong>:{" "}
                                      {saasUserInfo.payment_status}
                                    </li>
                                    <li>
                                      <strong>payment_gateway</strong>:{" "}
                                      {saasUserInfo.payment_gateway}
                                    </li>
                                    <li>
                                      <strong>amount</strong>:{" "}
                                      {saasUserInfo.amount}
                                    ...
                                    <li>
                                      <strong>available_item</strong>:{" "}
                                      {saasUserInfo.available_item}
                                    </li>
                                    <li>
                                      <strong>Branch</strong>: 100/
                                      {saasUserInfo.total_branch_items}
                                    </li>
                                    <li>
                                      <strong>Food Item</strong>: {foodLeft}/
                                      {saasUserInfo.total_food_items}
                                    </li>
                                  </ul>
                                </div>
                              </div>
